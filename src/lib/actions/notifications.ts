...
export async function markNotificationRead(notificationId: unknown): Promise<ActionResult> {
  ...
  try {
    ...
    return { success: false, error: "Could not mark notification as read. Please try again." };
  }
}
...
export async function markAllMyNotificationsRead(): Promise<ActionResult> {
  ...
  try {
    ...
    return { success: false, error: "Could not mark notifications as read. Please try again." };
  }
}
